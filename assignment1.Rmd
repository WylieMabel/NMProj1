...
*Guess better estimates of 𝜃1, 𝜃2 and 𝜃3 based on the analysis in (2). Describe the proce-
dure you used to obtain the guessed values.*
...
Estimate an ERGM with the edges and a deparment homophily parameters. Compute
the conditional probability of observing a tie between two managers 𝑖 and 𝑗 belonging to
the same department and interpret the result.		
...
*A tie is more likely between managers when it reciprocates a friendship nomination
(reciprocity).*

*A tie is more likely between managers when it closes a transitive two-path (transi-
tivity).*
...
*Evaluate the goodness of fit of the model according to four different auxiliary statistics.
